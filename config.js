window.SURVEY_CONFIG = Object.freeze({
  ...
  QUESTION_TIMESLICE_MS: 10000,
  FULL_TIMESLICE_MS: 60000,
  STORAGE_SAFETY_MB: 120,

  // true = conserva el comportamiento anterior: audio por pregunta + audio continuo.
  // false = solo audio continuo, aproximadamente la mitad del tamaño.
  RECORD_QUESTION_AUDIO: true,

  PACKAGE_FORMAT: 'ENCUESTA-OFFLINE-V4',
